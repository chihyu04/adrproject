...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:yen10172@localhost:5432/postgres'
...
class DoctorAccount(db.Model):
    __tablename__ = 'doctor_accounts'; __table_args__ = {'schema': 'hosp'}
...
DRUG_JSON_PATH = r"c:\Users\cindy\Downloads\adrproject-main\adrproject-main\api\drug_adverse.json"
